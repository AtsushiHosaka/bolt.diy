...
SVC_NAME="actions.runner.AtsushiHosaka-bolt.diy.hosakaatsushinoMac-mini"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (AtsushiHosaka-bolt.diy.hosakaatsushinoMac-mini)"
